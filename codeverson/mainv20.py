...
def reset(trash_type):
    ...
    # 根據垃圾桶種類決定要閃爍哪一顆 LED
    if trash_type == "紙容器回收桶":
        led_to_blink = blue_pin
    elif trash_type == "塑膠回收桶":
        led_to_blink = yellow_pin
    elif trash_type == "金屬回收桶":
        led_to_blink = green_pin
    elif trash_type == "一般垃圾桶":
        led_to_blink = red_pin
